...
from model_diffing.scripts.ma.utils import (
    l0_norm,
...
if __name__ == '__main__':
	...
	all_input=torch.tensor([(i,j,P) for i in range(P) for j in range(P)]).to(device)
	loss_orig,loss_rep,loss_zero,loss_recovered=get_loss_recovered(all_input,model,xc,data_cfg)
